...
class Feelings extends Component {
    ...
    createPlaylist(newPlaylist) {
        ...
        spotifyWebApi.getMe().then((response) => {
            ...
            var options = {
                name: name,
                description: "Autogenerated by Viktor Frohnapfel",
                public: false
            };
            ...
            spotifyWebApi.createPlaylist(userId, options).then((response) => {
                ...
                spotifyWebApi.addTracksToPlaylist(userId, playlistId, newPlaylist).then((response) => {

                    var details = { name: name, uri: uri };
    ...
    render() {
        ...
        return (
            <div className="Releases" style={{ background: 'black' }}>
                <h1 style={{ fontFamily: 'Gotham Bold', color: 'white', marginTop: '40px' }}>Create playlists from your library with your current feelings</h1>
                <div className="formLayout" style={{ margin: '12px', padding: '20px' }}>
                    <Form>
